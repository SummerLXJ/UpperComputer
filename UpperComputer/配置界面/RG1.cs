...
{
    public partial class RG1 : Channel
    {
        ...
        {
            this.count = 3 + GlobalVar.rf_num + GlobalVar.channel_length*2;
            this.infuence = 50 + GlobalVar.channel_length*2;
            //this.channel_index = 3;
            this.control_signal_index = 18;
        }
        Method method = new Method();
        public int information_site = 81+2*GlobalVar.channel_length;
