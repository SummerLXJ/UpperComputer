...
{
    public partial class RG3 : Channel
    {
        public RG3()
        {
            InitializeComponent();
        ...
        {
            this.count = 3 + GlobalVar.rf_num + GlobalVar.channel_length*4;
            this.infuence = 50 + GlobalVar.channel_length*4;
            //this.channel_index = 5;
            this.control_signal_index = 32;
        }
        Method method = new Method();
        public int information_site = 81 + 4 * GlobalVar.channel_length;
